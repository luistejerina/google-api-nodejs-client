...
describe('Options', () => {
    ...
    it('should allow overriding rootUrl via options', () => {
        const google = new googleapis.GoogleApis();
        const drive = google.drive('v3');
        const reqWithSlash = drive.files.get({ fileId: 'woot' }, { rootUrl: 'https://myrooturl.com/' }, utils_1.default.noop);
        ...
        const reqWithoutSlash = drive.files.get({ fileId: 'woot' }, { rootUrl: 'https://myrooturl.com' }, utils_1.default.noop);
