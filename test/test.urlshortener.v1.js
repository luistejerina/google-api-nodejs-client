...
function testSingleRequest(urlshortener) {
    ...
    const req = urlshortener.url.insert(obj, utils_1.default.noop);
...
function testParams(urlshortener) {
    ...
    const req = urlshortener.url.get(params, utils_1.default.noop);
...
describe('Urlshortener', () => {
    ...
    before((done) => {
        ...
        utils_1.default.loadApi(google, 'urlshortener', 'v1', {}, (err, urlshortener) => {
